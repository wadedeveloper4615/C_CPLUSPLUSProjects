...
typedef struct _FileRecordHeader {
        DWORD Magic;          // "FILE"
...
} FileRecordHeader, *FileRecordHeaderPtr, *FileRecordHeaderPtrPtr;
...
typedef struct _AttrHeaderCommon {
...
} AttrHeaderCommon, *AttrHeaderCommonPtr, **AttrHeaderCommonPtrPtr;
...
typedef void (*ATTR_RAW_CALLBACK)(const AttrHeaderCommonPtr attrHead, BOOL *bDiscard);
class CAttrBase;

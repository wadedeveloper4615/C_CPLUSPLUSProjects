...
CAttr_AttrList_AttrResident::CAttr_AttrList_AttrResident(const ATTR_HEADER_COMMON *ahc, const CFileRecord *fr) : CAttrResident(ahc, fr) {
...
CAttr_AttrList_AttrResident::~CAttr_AttrList_AttrResident() {
}
